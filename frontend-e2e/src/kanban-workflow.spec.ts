...
test.describe('Kanban Workflow', () => {
    ...
    test('should complete full workflow from backlog to done', async ({ page }) => {
    ...
    test('should update daily progress bar when moving tasks', async ({ page }) => {
    ...
    test('should preserve task data when moving between statuses', async ({ page }) => {
        const taskData = {
    ...
    test('should allow moving task backwards (Done to In Progress)', async ({ page }) => {
